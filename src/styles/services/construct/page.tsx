    ...
    services: [
        {
            ...
            description: "The EPC model ensures single-point accountability, combining engineering excellence, efficient procurement, and seamless construction delivery.",
            details: {
                "Scope of Work": [
        ...
        },
        {
            id: "design-build",
            title: "Design & Build",
            description: "A fast-track, integrated delivery model where Infra.Health manages the entire project — from design concept to physical handover.",
            details: {
                "Scope of Work": [
        ...
        },
        {
            ...
            description: "Hospitals must evolve and modernise without disrupting ongoing patient services. Infra.Health provides phased fitout and retrofit solutions to expand capacity, upgrade systems, and align with the latest compliance standards.",
            details: {
                "Scope of Work": [
        ...
        },
        {
            ...
            description: "Hospitals demand precision-engineered specialty systems that directly impact patient safety and operational efficiency. Infra.Health specialises in end-to-end delivery of critical hospital infrastructure systems.",
            details: {
                "Scope of Work": [
        ...
        <>
            <main className="container py-5 mt-4">
                <div className="text-left mx-auto mb-5 pb-4" style={{ maxWidth: '1920px' }}>
                    ...
                    <h1 className="section-title"><span>{constructData.intro.title}</span></h1>
                    <h2 className="fs-4 mb-3">{constructData.intro.main}</h2>
                    <p className="lead mt-3 text-muted">{constructData.intro.sub}</p>
                </div>
                    ...
                    <Col lg={3} className="d-none d-lg-block">
                        <Nav className="flex-column sticky-top sidenav">
                            {constructData.services.map(service => (
                                <Nav.Link key={service.id} href={`#${service.id}`} onClick={(e) => handleNavLinkClick(e, service.id)} className={activeLink === service.id ? 'active' : ''}>
                                    {service.title}
                                </Nav.Link>
                            ))}
                             <Nav.Link href="#why-infrahealth" onClick={(e) => handleNavLinkClick(e, 'why-infrahealth')} className={activeLink === 'why-infrahealth' ? 'active' : ''}>Why Infra.Health?</Nav.Link>
                        </Nav>
                    </Col>
                    ...
                    <Col lg={9}>
                        <div className="vstack gap-5">
                            ...
                            <section id="why-infrahealth">
                                ...
                                <div className="service-card">
                                    <DetailSection details={{ Points: constructData.why.points }} />
                                </div>
                            </section>
                        </div>
                    </Col>
